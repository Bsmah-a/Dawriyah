    ...
    var body: some View {
        NavigationStack{
            ZStack{
                ...
                VStack{
                HStack(spacing: 30){
                    RoundedRectangle (cornerRadius: 25).fill(Color("Color2")).frame(width: 130, height: 4).opacity(0.37)
                
                RoundedRectangle(cornerRadius: 25).fill(Color("Color2")).frame(width: 130, height: 4).padding()
                }
